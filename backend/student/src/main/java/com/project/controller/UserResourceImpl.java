...
public class UserResourceImpl  {
	...
	{	
	  ...
	  //cbasic 
		...
		//cinter
			...
			@GetMapping("/cadv")
			public int setcadv(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
			{	
				userRepository.setCadv(mark,name);
				return mark;
			}
			
			@GetMapping("/cmarkadv")
			public int getcadv(@RequestParam(value="name") String name)
			{	
				 int m=userRepository.getCadv(name);
				 return m;
			}
	...
	@GetMapping("/cpbasic")
	public int setcpbasic(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
	{	
		userRepository.setCplusbasic(mark,name);
		return mark;
	}
	
	@GetMapping("/cpmarkbasic")
	public int getcpbasic(@RequestParam(value="name") String name)
	{	
		 int m=userRepository.getCplusbasic(name);
		 return m;
	}

	 //cpinter	
	@GetMapping("/cpinter")
		public int setcpinter(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
		{	
			userRepository.setCplusinter(mark,name);
			return mark;
		}
		
		@GetMapping("/cpmarkinter")
		public int getcpinter(@RequestParam(value="name") String name)
		{	
			 int m=userRepository.getCplusinter(name);
			 return m;
		}
		 ...
		 //cpadv
		@GetMapping("/cpadv")
			public int setcpdv(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
			{	
				userRepository.setCplusadv(mark,name);
				return mark;
			}
			
			@GetMapping("/cpmarkadv")
			public int getcpadv(@RequestParam(value="name") String name)
			{	
				 int m=userRepository.getCplusadv(name);
				 return m;
			}
...
//python
	...
	@GetMapping("/py")
	public int setpy(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
	{	
		userRepository.setPy(mark,name);
		return mark;
	}
	
	@GetMapping("/pymark")
	public int getpy(@RequestParam(value="name") String name)
	{	
		 int m=userRepository.getPy(name);
		 return m;
	}
	...
	@GetMapping("/pybasic")
	public int setpybasic(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
	{	
		userRepository.setPybasic(mark,name);
		return mark;
	}
	
	@GetMapping("/pybasicmark")
	public int getpybasic(@RequestParam(value="name") String name)
	{	
		 int m=userRepository.getPybasic(name);
		 return m;
	}

	 //cpinter	
	@GetMapping("/pyinter")
		public int setpyinter(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
		{	
			userRepository.setPyinter(mark,name);
			return mark;
		}
		
		@GetMapping("/pymarkinter")
		public int getpyinter(@RequestParam(value="name") String name)
		{	
			 int m=userRepository.getPyinter(name);
			 return m;
		}
		 ...
		 //cpadv
		@GetMapping("/pyadv")
			public int setpyadv(@RequestParam(value="mark") int mark, @RequestParam(value="name") String name)
			{	
				userRepository.setPyadv(mark,name);
				return mark;
			}
			
			@GetMapping("/pymarkadv")
			public int getpyadv(@RequestParam(value="name") String name)
			{	
				 int m=userRepository.getPyadv(name);
				 return m;
			}
